...
class CTodo extends w2p_Core_BaseObject
{
	...
	public function getClosedTodosForDateRange($AppUI = null, $user_id = 0)
    {
		$user_id = ($user_id > 0) ? $user_id : $this->_AppUI->user_id;
	...
	public function getTodosForDateRange($AppUI = null, $dateRangeName, $user_id = 0, $project_id = 0, $contact_id = 0, $company_id = 0)
	{
